...
public class UiGame : Ui
{
    ...
    {
        _TimeText.text = Timer.timeInstance.CurrentTimeText();
    }
    ...
    {
        _WinRecordTime.text = ("YOUR TIME IS : " + Timer.timeInstance.CurrentTimeText());
    ...
    private IEnumerator Transition(float timeToDisable)
    {
        ...
        MonetizationManager.monetizationManagerInstance.HideBanner();
